...
[~, err1_a1y0,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha*0.8, gamma, 1);
[~, err1_ary0,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha*1.2, gamma, 1);
fprintf('RRMSE %d\n', err1);
...
[~, err2_a1y0,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha*0.8, gamma, 2);
[~, err2_ary0,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha*1.2, gamma, 2);
[~, err2_a0yl,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha, gamma*0.8, 2);
[~, err2_a0yr,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha, gamma*1.2, 2);
fprintf('RRMSE %d\n', err2);
...
[~, err3_a1y0,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha*0.8, gamma, 3);
[~, err3_ary0,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha*1.2, gamma, 3);
[~, err3_a0yl,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha, gamma*0.8, 3);
[~, err3_a0yr,~] = gradientDescent(imageNoiseless, imageNoisy, mask, alpha, gamma*1.2, 3);
fprintf('RRMSE %d\n', err3);
fprintf('RRMSE at 0.8*alpha, gamma %d\n', err3_a1y0);
fprintf('RRMSE at 1.2*alpha, gamma %d\n', err3_ary0);
fprintf('RRMSE at alpha, 0.8*gamma %d\n', err3_a0yl);
